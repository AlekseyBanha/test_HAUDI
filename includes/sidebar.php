...
<div class="block">
    ...
    <div class="block__content">
        <div class="articles articles__vertical">
            ...
            <?php
            $articles = mysqli_query($connection, "SELECT * FROM `artcl` ORDER BY `views` DESC LIMIT 5");
            ...
            while ($comment = mysqli_fetch_assoc($comments))
            {
                ...
                <article class="article">
                    ...
                    <div class="article__info">
                        ...
                        <div class="article__info__meta">
                        <div class="article__info__preview"><?php   echo mb_substr($comment['text'],0,14,'utf-8') . ' ...'?></div>
                    </div>
                </article>
                <?php
            }
